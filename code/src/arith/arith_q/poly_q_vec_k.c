...
*
* Arguments:   - poly_q_vec_k high: polynomial vector to host the high order decomposition (initialized)
*              - poly_q_vec_k low: polynomial vector to host the low order decomposition (initialized)
*              - const poly_q_vec_k arg: polynomial vector to be decomposed
**************************************************/
...
/*************************************************
* Name:        poly_q_vec_k_decompose_b2
*
* Description: Decompose coefficients of input vector into signed high order
...
*              - const poly_q_vec_k arg: the polynomial vector
*
